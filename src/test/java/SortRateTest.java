...
import com.movie_data_manipulation_program.Display_Top_5_Rated_Movie_Each_Genre_Each_Year;
...
public class SortRateTest {
    ...
    public static void prepareHashMap(){
        ...
        movieLinkedList.add(new Movie("tt0499549","Avatar","2009","PG-13","162 min","9","James Cameron","Sam Worthington#Zoe Saldana#Sigourney Weaver#Michelle Rodriguez","1322694","760507625"));
        ...
        movieLinkedList.add(new Movie("tt1856101","Blade Runner 2049","2017","R","164 min","8.9","Denis Villeneuve","Harrison Ford#Ryan Gosling#Ana de Armas#Dave Bautista","586274","920541599"));
    }

    @Test
    public void sortRateTest(){
        prepareHashMap();
        LinkedList<Movie> sortList = main.sort(movieLinkedList);
        assertEquals("Avatar",sortList.getFirst().getMovieName());
    }
}
